 ...
 */
/**
 * Modified by UnPLUG to use PHP sessions
 */
class CI_Session {
	...
	{	
		...
		$session = isset($_SESSION['session']) ? $_SESSION['session'] : array();
	...
	{	
		...
		$new_sessid = session_regenerate_id();
