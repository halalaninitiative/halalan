...
<div class="menu" id="menu_center">
	<div id="center_menu">
		...
		|
		<?= form_submit('submit', e('admin_edit_candidate_submit')) ?>
	</div>
	<div class="clear"></div>
</div>
<?= form_close(); ?>