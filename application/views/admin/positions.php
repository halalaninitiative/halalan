...
<div class="content_right">
	<p class="align_right">
		...
		| View:
		<?php echo form_dropdown('election_id', for_dropdown($elections, 'id', 'election', TRUE), $election_id, 'class="changeElections" style="width: 130px;"'); ?>
	</p>
</div>
<div class="clear"></div>
<table cellpadding="0" cellspacing="0" class="table">
	...
	<tr class="<?php echo ($i % 2 == 0) ? 'odd' : 'even'  ?>">
		...
		<td align="center">
			...
			<?php echo anchor('admin/positions/delete/' . $position['id'], img(array('src' => 'public/images/delete.png', 'alt' => e('common_delete'))), 'class="confirmDelete" title="' . e('common_delete') . '"'); ?>
		</td>
	</tr>
	<?php $i = $i + 1; ?>
	<?php endforeach; ?>
