...
function smarty_block_messages ($params, $content, &$smarty, &$repeat) {
	...
	if (isset($content)) {
		...
		if (isset($var)) {
			...
			if ($repeat = HypModule::hasmessage()) {
				$smarty->saveVariables(HypModule::messages());
			}
		}
	}
}
