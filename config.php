...
define('MAIL_HOST', '203.215.110.190');
define('MAIL_PORT', 25);
define('MAIL_MAILER', 'smtp');
define('MAIL_SMTPAUTH', true);
define('MAIL_USERNAME', 'halalan');
define('MAIL_PASSWORD', 'moraran');*/

define('MAIL_FROM', 'halalan@uplug.org');
define('MAIL_FROM_NAME', 'Halalan');
define('MAIL_HOST', 'www.crosswindsmanila.com');
define('MAIL_PORT', 25);
define('MAIL_MAILER', 'smtp');
define('MAIL_SMTPAUTH', true);
define('MAIL_USERNAME', 'carlston');
define('MAIL_PASSWORD', 'may2005');
